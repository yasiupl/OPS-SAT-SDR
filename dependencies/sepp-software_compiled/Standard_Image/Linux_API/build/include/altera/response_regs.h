...
#define RD_RESPONSE_ACTUAL_BYTES_TRANSFFERED(base)     IORD_32DIRECT(base, RESPONSE_ACTUAL_BYTES_TRANSFERRED_REG)
#define RD_RESPONSE_ERRORS_REG(base)                   IORD_32DIRECT(base, RESPONSE_ERRORS_REG)   // this read pops the response FIFO
