/*
  ...
  13-15     R               <Reserved 15:0>, Response Fill Level[15:0]
  16-31     N/A             <Reserved>
  ...
  8-12      R               Descriptor Fill Level (write fill level[15:0], read fill level[15:0])
  13-15     R               <Reserved 15:0>, Response Fill Level[15:0]
  16-19     R               Sequence Number (write sequence number[15:0], read sequence number[15:0])
  20-31     N/A             <Reserved>
...
// Define 32-bit word offset for CSR port registers
#define CSR_STATUS_REG                          (0x0)	// byte 0..3
#define CSR_CONTROL_REG                         (0x4)	// byte 4..7
#define CSR_DESCRIPTOR_FILL_LEVEL_REG           (0x8)	// byte 8..11
#define CSR_RESPONSE_FILL_LEVEL_REG             (0xC)	// byte 12..15
#define CSR_SEQUENCE_NUMBER_REG                 (0x10)	// byte 16..19, this register only exists when the enhanced features are enabled
